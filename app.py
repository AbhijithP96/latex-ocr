...
st.set_page_config(page_title='LaTeX Equation From Images',
...
# description
st.markdown('<p> Upload an image containing mathematical equations, and get the corresponding LaTeX code generated using NVIDIA AI Models.</p>', unsafe_allow_html=True)
...
if 'result' in st.session_state:
    ...
    st.info('Upload an image and click on "Generate LaTeX Code" to see the results here.')
    
st.markdown('---')
st.markdown('<p style="text-align: center;"> Made with Llama-3.2-Vision-Instruct </p>', unsafe_allow_html=True)
